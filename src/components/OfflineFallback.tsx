  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2 max-w-[360px]">
        <h2 className="m-0 text-xl font-bold leading-tight text-[#1A1A1A]">Kamu offline</h2>
        <p className="m-0 text-base font-normal leading-relaxed text-[#595959]">
      ...
      <button
        ...
        className="btn btn-primary min-h-[48px] h-12 w-full max-w-[360px] rounded-xl text-base font-semibold gap-2 border-none"
      >
        <RefreshDouble width={20} height={20} color="#FFFFFF" />
        Muat Ulang
      </button>

      <p className="m-0 text-sm text-[#595959]">Data lokal aman — tidak hilang</p>
    </div>
  );
}
