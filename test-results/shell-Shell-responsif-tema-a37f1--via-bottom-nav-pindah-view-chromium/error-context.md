...
- Name: shell.spec.ts >> Shell responsif + tema + primitif cantik >> mobile menu navigasi via bottom-nav pindah view
- Location: e2e/shell.spec.ts:137:3
...
Call log:
  - waiting for getByTestId('bottom-nav-promo')
...
```yaml
- generic [ref=f1e3]:
  - checkbox "Buka menu close sidebar Tutup"
  - generic [ref=f1e4]:
    - banner [ref=f1e5]:
      - generic [ref=f1e6]:
        - generic "Buka menu" [ref=f1e7] [cursor=pointer]
        - heading "Toko Nav Mobile" [level=1] [ref=f1e9]
      - generic [ref=f1e10]: PWA
    - main [ref=f1e12]:
      - generic [ref=f1e13]:
        - alert [ref=f1e14]:
          - generic [ref=f1e15]: Notifikasi dimatikan, badge tetap update
          - button "Tutup banner notifikasi" [ref=f1e17] [cursor=pointer]: Tutup
        - generic [ref=f1e18]:
          - generic [ref=f1e19]:
            - generic [ref=f1e24]:
              - heading "Katalog SKU" [level=2] [ref=f1e25]
              - paragraph [ref=f1e26]: Cari, filter, dan kelola barang — semua stok di satu tempat.
            - generic [ref=f1e28]:
              - button "Barang Masuk" [ref=f1e29] [cursor=pointer]
              - button "Tambah SKU" [ref=f1e30] [cursor=pointer]
          - searchbox "Cari SKU" [ref=f1e34]
          - group "Filter kategori dan tag" [ref=f1e35]:
            - generic [ref=f1e36]: Filter kategori
            - combobox "Filter kategori" [ref=f1e37]:
            ...
            - generic [ref=f1e38]: Filter tag
            - combobox "Filter tag" [ref=f1e39]:
              - option "Semua tag" [selected]
          - status [ref=f1e40]:
            - generic [ref=f1e42]:
              - heading "Belum ada SKU" [level=3] [ref=f1e46]
              - paragraph [ref=f1e47]: Mulai dengan tambah barang pertama. Mudah — cukup nama, kategori, dan harga.
              - button "Tambah SKU" [ref=f1e49] [cursor=pointer]
          - status [ref=f1e50]: 0 SKU ditemukan
    - navigation "Navigasi utama" [ref=f1e52]:
      - button "Dashboard" [ref=f1e53]
      - button "SKU" [active] [ref=f1e58]
      - button "Pengaturan" [ref=f1e62]
```
