...
- Name: shell.spec.ts >> Shell responsif + tema + primitif cantik >> mobile 390: bottom-nav terlihat + hamburger buka drawer overlay
- Location: e2e/shell.spec.ts:68:3
...
Locator: getByTestId('bottom-nav-promo')
Expected: visible
Timeout: 5000ms
...
- banner:
  - img
  - heading "Toko Shell Mobile" [level=1]
  - text: PWA
- main:
  - img
